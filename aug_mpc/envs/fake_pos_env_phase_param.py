...
class FakePosEnvPhaseParam(PhaseParametrizationBaseline):
    ...
    def get_file_paths(self):
        paths=PhaseParametrizationBaseline.get_file_paths(self)
        paths.append(os.path.abspath(__file__))        
        return paths
    
    def _custom_post_init(self):
        PhaseParametrizationBaseline._custom_post_init(self)
