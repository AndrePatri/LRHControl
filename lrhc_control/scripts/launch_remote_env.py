...
if __name__ == '__main__':
    ...
    parser.add_argument('--contacts_list', nargs='+', default=None,
                        help='Contact sensor list (needs to match an available body)')
    ...
    sim_params["env_spacing"] = 6
    sim_params["use_flat_ground"] = True
    sim_params["spawning_radius"] = 1.0
    sim_params["cloning_offset"] = np.array([[0.0, 0.0, args.spawning_height]] * num_envs)
    ...
    sim_params["contact_prims"] = contact_prims
    sim_params["sensor_radii"] = sensor_radii
    sim_params["contact_offsets"] = contact_offsets

    sim_params["n_envs"] = num_envs 
    sim_params["control_clust_dt"] = control_clust_dts
    sim_params["headless"] = headless
    sim_params["enable_livestream"] = False
