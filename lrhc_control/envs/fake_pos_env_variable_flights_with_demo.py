...
class FakePosEnvVariableFlightsWithDemo(FakePosEnvVariableFlights):
    ...
    def __init__(self,
        ...
        self._add_env_opt(env_opts, "smoothing_horizon_twist", 
            0.08)
        self._add_env_opt(env_opts, "use_default_flight_params", 
            True)
        self._add_env_opt(env_opts, "default_flen", 
            20)
        self._add_env_opt(env_opts, "default_fapex", 
            0.15)
        self._add_env_opt(env_opts, "default_fdend", 
            0.0)
